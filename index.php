                    ...
                    <table>
                        ...
                        <?php foreach ($_SESSION['produtos'] as $produto): ?>
                            ...
                            <tr>
                                ...
                                <td class="crementos">
                                    <a href="?decrementar=<?php echo $produto['id']; ?>"><img src="img/minus.png" alt="" class="icon_operator"></a>
                                </td>
                                <td>
                                    <?php echo $produto['qtd_estoque']; ?>
                                </td>
                                <td class="crementos">
                                    <a href="?incrementar=<?php echo $produto['id']; ?>"><img src="img/plus.png" alt="" class="icon_operator"></a>
                                </td>
